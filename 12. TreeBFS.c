...
Algorithm:
Step 1:
Start and read the number of values n.

Step 2:
For each value:
Insert it into the Binary Search Tree (BST) using the insert() function.

Step 3:
Initialize a queue and insert the root node into the queue.

Step 4 (Level Order Traversal):
